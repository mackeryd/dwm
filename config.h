...
static char *fonts[]          = { "monospace:size=9", "NotoColorEmoji:pixelsize=18:antialias=true:autohint=true", "FontAwesome6Brands:pixelsize=24:antialias=true:autohint=true"  };
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "90x26", NULL };
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=10", "-g", "25x10", "-e", "bc", "-lq", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_w,		spawn,		SHCMD(TERMINAL " -e lynx") },
	...
	{ MODKEY|ShiftMask,		XK_backslash,		spawn,		SHCMD("vimde") },

	{ MODKEY,			XK_a,		togglegaps,	{0} },
	{ MODKEY|ShiftMask,		XK_a,		defaultgaps,	{0} },
	{ MODKEY,			XK_s,		togglesticky,	{0} },
	{ MODKEY|ShiftMask,		XK_s,		spawn,		SHCMD("touchpad_toggle") },
	...
	{ MODKEY|ShiftMask,		XK_x,		spawn,		SHCMD("rssadd") },
	{ MODKEY,			XK_c,		spawn,		SHCMD("clipmenu") },
	{ MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("citrix") },
	...
	{ MODKEY|ShiftMask,		XK_Insert,	spawn,		SHCMD("bookmarkthis") },
